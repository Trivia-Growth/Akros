---
name: state-historico-2026-08
description: Histórico arquivado de docs/STATE.md — agosto/2026. Rodadas 1 e 2 (E00–E11), épico E12 (auth) e épico E13 (schema real + RLS). Puxe só quando precisar de contexto anterior.
alwaysApply: false
---

# Histórico do STATE — agosto/2026

> Arquivado em 2026-08-31 a partir de `docs/STATE.md`, que tinha chegado a 606 linhas / 41,8 kB
> sendo lido em toda sessão. Nada foi encurtado — só movido. O estado corrente vive em
> `docs/STATE.md`, seção `## Agora`.

## 2026-08-19 — Rodadas 1 e 2 especificadas e implementadas (E00–E11)
