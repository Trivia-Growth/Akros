...
class PolicySync {
  ...
  /**
   * Get TRIVIAIOX permission policies
   */
  async getTRIVIAIOXPolicies() {
    const policiesPath = path.join(this.projectDir, ".triviaiox", "policies.json");
  ...
  async exportToGemini() {
    const policies = await this.getTRIVIAIOXPolicies();
