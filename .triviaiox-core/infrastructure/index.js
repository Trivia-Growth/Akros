 ...
 * This is the base layer of the TRIVIAIOX modular architecture.
 *
...
function safeRequire(modulePath) {
  try {
    ...
    if (process.env.TRIVIAIOX_DEBUG) {
...
// Validation
const TriviaioxValidator = safeRequire("./scripts/triviaiox-validator");
