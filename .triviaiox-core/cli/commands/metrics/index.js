...
function createMetricsCommand() {
  ...
  metrics.description("Quality Gates Metrics - collect and analyze quality data").addHelpText(
    "after",
    `
Commands:
...
Data Storage:
  Metrics are stored in .triviaiox/data/quality-metrics.json
...
Examples:
  $ triviaiox metrics record --layer 1 --passed --duration 3200
  $ triviaiox metrics record --layer 2 --passed --findings 3 --coderabbit
  $ triviaiox metrics show
  $ triviaiox metrics show --layer 2
  $ triviaiox metrics show --format json
  $ triviaiox metrics seed --days 30
  $ triviaiox metrics cleanup
  $ triviaiox metrics cleanup --dry-run
`,
  );
