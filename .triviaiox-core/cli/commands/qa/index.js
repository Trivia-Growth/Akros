...
Examples:
  $ triviaiox qa run                    Run full pipeline
  $ triviaiox qa run --layer=1          Run only Layer 1 (pre-commit)
  $ triviaiox qa run --layer=2          Run only Layer 2 (PR automation)
  $ triviaiox qa run --verbose          Run with detailed output
  $ triviaiox qa status                 Show current gate status
