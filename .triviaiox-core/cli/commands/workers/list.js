 ...
 *
 * Implements `triviaiox workers list` CLI command.
...
function createListCommand() {
  ...
  list
    ...
    .addHelpText(
      ...
      `
Examples:
  $ triviaiox workers list
  $ triviaiox workers list --category=task
  $ triviaiox workers list --format=table
  $ triviaiox workers list --format=json --category=script
  $ triviaiox workers list --page=2 --limit=10
  $ triviaiox workers list --count
  $ triviaiox workers list --verbose
