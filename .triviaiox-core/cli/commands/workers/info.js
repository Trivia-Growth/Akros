 ...
 *
 * Implements `triviaiox workers info <id>` CLI command.
...
function createInfoCommand() {
  ...
  info
    ...
    .addHelpText(
      ...
      `
Examples:
  $ triviaiox workers info json-csv-transformer
  $ triviaiox workers info architect-checklist --format=json
  $ triviaiox workers info create-story --format=yaml
  $ triviaiox workers info data-analyzer --verbose
