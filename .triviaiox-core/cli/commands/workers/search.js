 ...
 *
 * Implements `triviaiox workers search <query>` CLI command.
...
function createSearchCommand() {
  ...
  search
    ...
    .addHelpText(
      ...
      `
Examples:
  $ triviaiox workers search "json csv"
  $ triviaiox workers search "data transformation" --category=etl
  $ triviaiox workers search "validation" --tags=schema,json
  $ triviaiox workers search "api" --format=json --limit=5
  $ triviaiox workers search "transform" --semantic
  $ triviaiox workers search "convert" --keyword
`,
    )
