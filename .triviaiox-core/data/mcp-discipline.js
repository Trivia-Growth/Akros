...
//
// Usage:
//   node .triviaiox-core/data/mcp-discipline.js --apply     # Disable non-essential
//   node .triviaiox-core/data/mcp-discipline.js --restore   # Re-enable all
//   node .triviaiox-core/data/mcp-discipline.js --status    # Show current state
//   node .triviaiox-core/data/mcp-discipline.js --enable <server>  # Re-enable specific
// =============================================================================
...
const BACKUP_PATH = path.join(PROJECT_ROOT, ".triviaiox", "mcp-backup.json");
const CAPABILITIES_PATH = path.join(PROJECT_ROOT, ".triviaiox", "runtime-capabilities.json");
