#!/usr/bin/env node
// =============================================================================
// TRIVIAIOX Capability Detection Module
// =============================================================================
...
//
// Usage:
//   node .triviaiox-core/data/capability-detection.js
//
// Output:
//   .triviaiox/runtime-capabilities.json
// =============================================================================
...
const OUTPUT_PATH = path.join(PROJECT_ROOT, ".triviaiox", "runtime-capabilities.json");
...
function loadToolRegistry() {
  const registryPath = path.join(PROJECT_ROOT, ".triviaiox-core", "data", "tool-registry.yaml");
  try {
    ...
    for (const line of content.split("\n")) {
      ...
      if (tierMatch) {
        tools[currentTool].tier = Number.parseInt(tierMatch[1]);
        continue;
      }
