...
/**
 * TRIVIAIOX Unified Statusline v3 for Claude Code
 *
 * Displays: Session | Model | Context Bar | Time | Agent | Squad | Project:Branch | Git | Messages | Alert
 *
 * Installed automatically by `npx triviaiox-core install` when no existing statusline is detected.
 * Source: .triviaiox-core/product/templates/statusline/
 */
