...
/**
 * Known TRIVIAIOX task registry commands
 * @type {Set<string>}
 */
...
class PatternValidator {
  ...
  validate(pattern) {
    ...
    // Rule 6: All commands should exist in TRIVIAIOX task registry
  ...
  /**
   * Check if a command is known in the TRIVIAIOX task registry
