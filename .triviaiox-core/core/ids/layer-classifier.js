 ...
 *
 * Layer Model:
 *   L1 (Framework Core)      — .triviaiox-core/core/, bin/, constitution.md
 *   L2 (Framework Templates)  — .triviaiox-core/development/, infrastructure/, product/
 *   L3 (Project Config)       — .triviaiox-core/data/, MEMORY.md, .claude/, *-config.yaml
...
const LAYER_RULES = [
  // --- L1: Framework Core ---
  { layer: "L1", test: (p) => p.startsWith(".triviaiox-core/core/") },
  { layer: "L1", test: (p) => p.startsWith("bin/") },
  { layer: "L1", test: (p) => p === ".triviaiox-core/constitution.md" },

  // --- L3: Project Config (before L2 to catch MEMORY.md inside agents/) ---
  { layer: "L3", test: (p) => p.startsWith(".triviaiox-core/data/") },
  ...
  { layer: "L2", test: (p) => p.startsWith(".triviaiox-core/development/") },
  { layer: "L2", test: (p) => p.startsWith(".triviaiox-core/infrastructure/") },
  { layer: "L2", test: (p) => p.startsWith(".triviaiox-core/product/") },
