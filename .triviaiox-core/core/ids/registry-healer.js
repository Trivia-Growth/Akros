...
const HEALING_LOG_PATH = path.resolve(REPO_ROOT, ".triviaiox-core/data/registry-healing-log.jsonl");
const HEALING_BACKUP_DIR = path.resolve(REPO_ROOT, ".triviaiox-core/data/registry-backups/healing");
...
class RegistryHealer {
   ...
   * Integrates with TRIVIAIOX NotificationManager (console + file channels).
   *
    ...
    switch (issue.ruleId) {
      ...
      default:
        return [
          ...
          "Run 'triviaiox ids:health --fix' after resolving",
        ];
    }
  }
