...
const LOCK_FILE = path.resolve(REPO_ROOT, ".triviaiox-core/data/.entity-registry.lock");
const BACKUP_DIR = path.resolve(REPO_ROOT, ".triviaiox-core/data/registry-backups");
const AUDIT_LOG_PATH = path.resolve(REPO_ROOT, ".triviaiox-core/data/registry-update-log.jsonl");
...
if (require.main === module) {
  ...
  if (args.includes("--watch")) {
    ...
    const limit = limitIdx >= 0 ? Number.parseInt(args[limitIdx + 1], 10) : 20;
