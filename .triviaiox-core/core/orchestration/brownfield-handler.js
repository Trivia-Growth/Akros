...
class BrownfieldHandler extends EventEmitter {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.workflowPath = path.join(
      projectRoot,
      ".triviaiox-core/development/workflows/brownfield-discovery.yaml",
    );
  ...
  _buildDiscoverySummary() {
    ...
    if (fs.existsSync(debtReportPath)) {
      try {
        ...
        if (dbIssuesMatch) {
          summary.databaseIssues = Number.parseInt(dbIssuesMatch[1], 10);
        }
      ...
      case PostDiscoveryChoice.RESOLVE_DEBTS:
        ...
        return {
          ...
          data: {
            ...
            taskPath: ".triviaiox-core/development/tasks/brownfield-create-epic.md",
            context,
          },
        };
