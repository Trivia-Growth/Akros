 ...
 * @constant {string[]}
 */
const DEFAULT_GREENFIELD_INDICATORS = ["package.json", ".git", "docs/", "src/", ".triviaiox-core/"];
...
class GreenfieldHandler extends EventEmitter {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.workflowPath = path.join(
      projectRoot,
      ".triviaiox-core/development/workflows/greenfield-fullstack.yaml",
    );
  ...
  async _executePhase0(context) {
    ...
    const spawnResult = await this._spawnAgent("@devops", "environment-bootstrap", {
      ...
      creates: [
        ...
        ".triviaiox/environment-report.json",
        ".gitignore",
        "README.md",
        "package.json",
      ],
