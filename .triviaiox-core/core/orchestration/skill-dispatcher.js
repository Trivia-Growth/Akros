/**
 * Skill Dispatcher - Dispatches to TRIVIAIOX Skills instead of generic Task calls
 *
 ...
 *
 * Responsibilities:
 * - Map agent IDs to TRIVIAIOX Skill names
 ...
 * @property {string} skill - Full skill name (e.g., 'TRIVIAIOX:agents:architect')
...
/**
 * Dispatches workflow phases to TRIVIAIOX Skills
 */
/**
...
class SkillDispatcher {
  ...
  constructor(options = {}) {
     ...
     * These correspond to files in .claude/commands/TRIVIAIOX/agents/
     */
    this.skillMapping = {
      // Core development agents
      architect: "TRIVIAIOX:agents:architect",
      "data-engineer": "TRIVIAIOX:agents:data-engineer",
      dev: "TRIVIAIOX:agents:dev",
      qa: "TRIVIAIOX:agents:qa",

      // Product agents
      pm: "TRIVIAIOX:agents:pm",
      po: "TRIVIAIOX:agents:po",
      sm: "TRIVIAIOX:agents:sm",
      analyst: "TRIVIAIOX:agents:analyst",

      // Specialized agents
      "ux-design-expert": "TRIVIAIOX:agents:ux-design-expert",
      "ux-expert": "TRIVIAIOX:agents:ux-design-expert", // Alias
      devops: "TRIVIAIOX:agents:devops",
      "github-devops": "TRIVIAIOX:agents:devops", // Alias

      // Master agent
      "triviaiox-master": "TRIVIAIOX:agents:triviaiox-master",
    };
    ...
    this.agentPersonas = {
      ...
      "triviaiox-master": { name: "Orion", title: "Master Orchestrator" },
    };
  }
   ...
   * @returns {string} Full skill name (e.g., 'TRIVIAIOX:agents:architect')
   */
  getSkillName(agentId) {
    return this.skillMapping[agentId] || `TRIVIAIOX:agents:${agentId}`;
  }
  ...
  getAgentPersona(agentId) {
    return this.agentPersonas[agentId] || { name: agentId, title: "TRIVIAIOX Agent" };
  }
  ...
  isValidAgent(agentId) {
    return agentId in this.skillMapping || agentId.startsWith("TRIVIAIOX:");
  }
}
