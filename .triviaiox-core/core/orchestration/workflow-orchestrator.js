 ...
 * and executes the defined task following TRIVIAIOX methodology.
 *
...
class WorkflowOrchestrator {
  ...
  _resolveConfidenceThreshold(explicitThreshold) {
    ...
    const envThreshold = Number(process.env.TRIVIAIOX_DELIVERY_CONFIDENCE_THRESHOLD);
