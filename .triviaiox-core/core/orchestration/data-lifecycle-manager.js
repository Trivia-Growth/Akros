...
const ARCHIVE_DIR = ".triviaiox/archive/sessions";
const SNAPSHOTS_DIR = ".triviaiox/snapshots";
...
class DataLifecycleManager {
   ...
   *
   * Sessions with last_updated > 30 days are moved to .triviaiox/archive/sessions/
   *
