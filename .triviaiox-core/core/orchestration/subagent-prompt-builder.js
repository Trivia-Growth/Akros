...
class SubagentPromptBuilder {
  ...
  constructor(projectRoot) {
    ...
    this.triviaioxCoreRoot = path.join(projectRoot, ".triviaiox-core");

    // Paths to TRIVIAIOX components
    this.paths = {
      agents: path.join(this.triviaioxCoreRoot, "development", "agents"),
      tasks: path.join(this.triviaioxCoreRoot, "development", "tasks"),
      checklists: path.join(this.triviaioxCoreRoot, "product", "checklists"),
      templates: path.join(this.triviaioxCoreRoot, "product", "templates"),
    };
  }
