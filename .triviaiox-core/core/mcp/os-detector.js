...
/**
 * Get global TRIVIAIOX directory path
 * @returns {string} Path to ~/.triviaiox/
 */
function getGlobalTriviaioxDir() {
  return path.join(getHomeDir(), ".triviaiox");
}

/**
 * Get global MCP directory path
 * @returns {string} Path to ~/.triviaiox/mcp/
 */
function getGlobalMcpDir() {
  return path.join(getGlobalTriviaioxDir(), "mcp");
}

/**
 * Get global MCP config file path
 * @returns {string} Path to ~/.triviaiox/mcp/global-config.json
 */
 ...
 * @returns {string} Path to ~/.triviaiox/mcp/servers/
 */
 ...
 * @returns {string} Path to ~/.triviaiox/mcp/cache/
 */
 ...
 * @returns {string} Path to ~/.triviaiox/credentials/
 */
function getCredentialsDir() {
  return path.join(getGlobalTriviaioxDir(), "credentials");
}
