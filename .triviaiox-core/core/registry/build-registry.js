 ...
 *
 * Scans TRIVIAIOX modules and builds the service registry JSON file.
...
const SCAN_SOURCES = [
  {
    pattern: ".triviaiox-core/development/tasks/**/*.md",
    category: "task",
  ...
  {
    pattern: ".triviaiox-core/product/templates/**/*.md",
    category: "template",
    taskFormat: "TEMPLATE",
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: ".triviaiox-core/infrastructure/scripts/**/*.js",
    category: "script",
    taskFormat: "SCRIPT",
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: ".triviaiox-core/product/checklists/**/*.md",
    category: "checklist",
    taskFormat: "CHECKLIST",
    subcategoryExtractor: () => "quality",
  },
  {
    pattern: ".triviaiox-core/development/workflows/**/*.yaml",
    category: "workflow",
    taskFormat: "WORKFLOW",
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: ".triviaiox-core/core/data/**/*.md",
    category: "data",
    taskFormat: "TASK-FORMAT-V1",
    subcategoryExtractor: () => "knowledge",
  },
  {
    pattern: ".triviaiox-core/core/data/**/*.yaml",
    category: "data",
    taskFormat: "TASK-FORMAT-V1",
...
async function main() {
  ...
  const outputPath =
    process.argv[3] || path.join(baseDir, ".triviaiox-core/core/registry/service-registry.json");
