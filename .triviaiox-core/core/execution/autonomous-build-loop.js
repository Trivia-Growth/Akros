 ...
 * Inspired by Auto-Claude's Coder Agent but with TRIVIAIOX extensibility.
 *
 * Features:
 * - AC1: Located in `.triviaiox-core/core/execution/`
...
async function main() {
  ...
  if (args.length === 0 || args.includes("--help") || args.includes("-h")) {
    console.log(`
${chalk.bold("Autonomous Build Loop")} - TRIVIAIOX Coder Agent Loop (Story 8.1)
