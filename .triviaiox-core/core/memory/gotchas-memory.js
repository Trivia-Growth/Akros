 ...
 *
 * Features:
 * - AC1: gotchas-memory.js in .triviaiox-core/core/memory/
 * - AC2: Persists in .triviaiox/gotchas.json and .triviaiox/gotchas.md
...
const CONFIG = {
  // Output paths
  gotchasJsonPath: ".triviaiox/gotchas.json",
  gotchasMdPath: ".triviaiox/gotchas.md",
  errorTrackingPath: ".triviaiox/error-tracking.json",
  ...
  // Version
  version: "1.0.0",
  schemaVersion: "triviaiox-gotchas-memory-v1",
};
  ...
  getStatistics() {
    ...
    return {
      ...
      pendingAutoCapture: [...this.errorTracking.values()].filter(
        (t) =>
          t.count >= this.options.repeatThreshold - 1 && t.count < this.options.repeatThreshold,
      ).length,
    };
  }
...
> Auto-generated by TRIVIAIOX Gotchas Memory
> Last updated: ${now}
...
*Generated by TRIVIAIOX Gotchas Memory v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Memory - TRIVIAIOX Memory Layer (Story 9.4)
