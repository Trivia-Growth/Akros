 ...
 *
 * Provides comprehensive health checking capabilities for TRIVIAIOX projects.
 ...
 * The primary diagnostic interface is `triviaiox doctor` (bin/triviaiox.js → core/doctor/).
 * The agent-facing task `*health-check` now delegates to `triviaiox doctor --json`
 ...
 *
 * @module triviaiox-core/health-check
 * @version 1.0.0
