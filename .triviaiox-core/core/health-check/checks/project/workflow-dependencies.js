 ...
 *
 * @module triviaiox-core/health-check/checks/project/workflow-dependencies
 * @version 1.0.0
...
class WorkflowDependenciesCheck extends BaseCheck {
  constructor() {
    super({
      ...
      cacheable: true,
      healingTier: 0,
      tags: ["triviaiox", "workflows", "dependencies"],
    });
  }
  ...
  async execute(context) {
    ...
    const workflowPaths = [
      path.join(projectRoot, ".triviaiox-core", "development", "workflows"),
      path.join(projectRoot, ".triviaiox-core", "infrastructure", "workflows"),
    ];
    ...
    const taskPaths = [
      path.join(projectRoot, ".triviaiox-core", "development", "tasks"),
      path.join(projectRoot, ".triviaiox-core", "infrastructure", "tasks"),
    ];
