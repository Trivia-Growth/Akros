 ...
 */
const DEFAULT_CONFIG_PATH = ".triviaiox-core/core/quality-gates/quality-gate-config.yaml";
...
class QualityGateManager {
   ...
   */
  async getStatus() {
    const statusPath = this.config.status?.location || ".triviaiox/qa-status.json";
  ...
  async saveReport(storyId = "unknown") {
    const reportDir = this.config.reports?.location || ".triviaiox/qa-reports";
