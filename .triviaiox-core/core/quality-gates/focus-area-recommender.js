...
class FocusAreaRecommender {
  ...
  analyzeChangedFiles(changedFiles = []) {
    ...
    const categoryPatterns = [
      ...
      },
      {
        ...
        category: "triviaiox-core",
        highlight: "TRIVIAIOX framework changes",
        risk: "high",
      },
      {
  ...
  determineSecondaryAreas(fileAnalysis, _layer2Result) {
    ...
    const secondaryCategories = ["ux", "configuration", "performance", "triviaiox-core"];
  ...
  getReviewQuestions(category) {
    const questionBank = {
      ...
      "triviaiox-core": [
        "Does this follow TRIVIAIOX framework patterns?",
