...
class Layer1PreCommit extends BaseLayer {
  ...
  async runLint(context = {}) {
    ...
    try {
      ...
      const errorCount = errorMatch ? Number.parseInt(errorMatch[1]) : hasErrors ? 1 : 0;
      const warningCount = warningMatch ? Number.parseInt(warningMatch[1]) : 0;
