/**
 * TRIVIAIOX Doctor — Environment Health Check Orchestrator
 *
 * Runs 12 modular checks against the TRIVIAIOX environment and returns
 * structured results with optional --fix, --json, and --dry-run support.
 *
 * @module triviaiox-core/doctor
 * @version 2.0.0
 * @story INS-4.1
 */
