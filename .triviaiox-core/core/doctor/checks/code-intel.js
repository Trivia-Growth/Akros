 ...
 *
 * @module triviaiox-core/doctor/checks/code-intel
...
async function run(context) {
  const codeIntelDir = path.join(context.projectRoot, ".triviaiox-core", "core", "code-intel");
    ...
    if (!available) {
      ...
      if (fs.existsSync(registryPath)) {
        ...
        return {
          ...
          fixCommand: "node .triviaiox-core/development/scripts/populate-entity-registry.js",
        };
      }
