 ...
 * const { recordPreCommitMetrics } = require('./.triviaiox-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { recordPRReviewMetrics } = require('./.triviaiox-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { recordHumanReviewMetrics } = require('./.triviaiox-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { withPreCommitMetrics } = require('./.triviaiox-core/quality/metrics-hook');
 *
  ...
  (async () => {
    switch (command) {
      case "pre-commit": {
        ...
        const duration = Number.parseInt(args[2], 10) || 0;
        const findings = Number.parseInt(args[3], 10) || 0;
