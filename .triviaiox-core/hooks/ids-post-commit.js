 ...
 *
 * Usage: node .triviaiox-core/hooks/ids-post-commit.js
 */
...
async function main() {
  ...
  if (process.env.TRIVIAIOX_IDS_FORCE !== "1" && isDocsOnlyCommit(changes)) {
  ...
  try {
    const { RegistryUpdater } = require(
      path.resolve(REPO_ROOT, ".triviaiox-core/core/ids/registry-updater.js"),
    );
