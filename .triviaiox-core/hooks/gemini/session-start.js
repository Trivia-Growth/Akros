#!/usr/bin/env node
/**
 * TRIVIAIOX Session Start Hook for Gemini CLI
 * Story GEMINI-INT.6 - TRIVIAIOX Hooks System
 *
 * Executes at session start to load TRIVIAIOX context and memory.
...
async function sessionStart() {
  ...
  try {
    const codebaseMapPath = path.join(projectDir, ".triviaiox", "codebase-map.json");
