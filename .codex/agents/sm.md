...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .triviaiox-core/development/scripts/unified-activation-pipeline.js sm
...
- **@po (Pax):** Coordinates with on backlog, sprint planning, and privacy classification gate
...
- SRE / SLO definition for a feature → Use @reliability
- Prompt design or eval for an LLM feature → Use @prompt-engineer
- Privacy classification / PIA for stories touching PII → Use @po via `*data-classification`
...
5. **Process correction** → Escalate to `@triviaiox-master *correct-course` if issues
...
---
---
*TRIVIAIOX Agent - Synced from .triviaiox-core/development/agents/sm.md*
