...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .triviaiox-core/development/scripts/unified-activation-pipeline.js dev
  ...
  - STAY IN CHARACTER!
  - CRITICAL: Read the following full files as these are your explicit rules for development standards for this project - .triviaiox-core/core-config.yaml devLoadAlwaysFiles list
...
dependencies:
  ...
  coderabbit_integration:
    ...
    workflow: |
      ...
      WHILE iteration < max_iterations:
        1. Run: wsl bash -c 'cd /mnt/c/.../triviaiox-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'
  ...
  decision_logging:
    ...
    utility: '.triviaiox-core/utils/decision-log-generator.js'
    ...
    usage_example: |
      ...
      const { generateDecisionLog } = require('.triviaiox-core/utils/decision-log-generator');
...
---
---
*TRIVIAIOX Agent - Synced from .triviaiox-core/development/agents/dev.md*
